"""
Data models for CL-SRS system with strict schema validation
"""
...
class Item(BaseModel):
    ...
    @field_validator('generator_params')
    def validate_generator_params(cls, v, info):
        if info.data.get('type') == ItemType.VARIANT and v is None:
